...
/**
 * This is the model class for table "myfavouriteshiftsavailable".
 *
 * @property integer $id
 ...
 */
class Myfavouriteshiftsavailable extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'myfavouriteshiftsavailable';
    }
