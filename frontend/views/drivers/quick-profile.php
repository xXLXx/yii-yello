            ...
            <div class="user-photo-info-inner">
                ...
                <div class="text-small-11 gray-text">Yello ID: #<?= $driver->id ?></div>
                    <div>
                        ...
                        <?php echo \kartik\rating\StarRating::widget(['value' => $review_avg, 'id' => 'rating0']); ?>
    ...
    <div class="company-list">
        <?php foreach ($reviews as $review):?>
            <div class="company-item">
                ...
                <div><?php echo \kartik\rating\StarRating::widget(['value' => $review->stars, 'id' => 'review-rating' . $review->id]); ?></div>
                <div><?= $review->text; ?></div>
                <div class="gray-text">
                    <?php
