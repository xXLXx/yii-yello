...
<div class="login-container-inner">
    <div class="login-popup width-266">
        <div class="select-form">
            <form action="">
                <h2 class="center"><?= \Yii::t('app', 'Driver Website Coming Soon'); ?></h2>
                <p style="text-align: justify;">Thank you for visiting us. Your exclusive driver's website is on its way. Meanwhile you may like to download the app or subscribe using these buttons.</p>
